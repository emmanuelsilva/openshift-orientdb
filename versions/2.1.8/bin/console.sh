...
[ -f "$ORIENTDB_HOME"/lib/orientdb-tools-2.1.8.jar ] || ORIENTDB_HOME=`cd "$PRGDIR/.." ; pwd`
...
exec "$JAVA" -client $JAVA_OPTS $ORIENTDB_SETTINGS $SSL_OPTS \
    -Dfile.encoding=utf-8 -Dorientdb.build.number="2.1.x@r${buildNumber}; 2015-12-17 11:51:38+0100" \
    -cp "$ORIENTDB_HOME/lib/orientdb-tools-2.1.8.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \
